...
try {
    ...
    mvn -q -pl code-graph-dba -am test '-Dtest=NativeVendorTest,NativeReviewTest,NativeMongoRenameTest,NativeMongoSettingsTest,NativeRedisTransactionTest,NativeRedisStreamTest' '-Dsurefire.failIfNoSpecifiedTests=false' '-Djava.awt.headless=true' '-Dtest.jvm.args=-Xmx256m -XX:MaxDirectMemorySize=64m'
