...
final class ProjectContexts implements AutoCloseable {
    ...
    synchronized void tick(){
        ...
        for(JsonNode raw:ordered){
            ObjectNode b=(ObjectNode)raw;if(!active(b,live))continue;String key;try{key=key(b);}catch(IllegalArgumentException removed){continue;}
