...
final class SqlScript {
    ...
    private enum Mode {NORMAL,LINE,SINGLE,DOUBLE,BACKTICK,BRACKET,BLOCK,DOLLAR}
    private static final class State {Mode mode=Mode.NORMAL;int blockDepth;String dollar;}
