...
class DbaTest {
    ...
    @Test void simpleParameterizedSelectAndQuotedSemicolonsWork(){assertEquals("SELECT 1",SqlReadGuard.validate("SELECT 1"));assertDoesNotThrow(()->SqlReadGuard.validate("SELECT ';' AS x FROM public.example WHERE id = ?"));}
