...
public class NativeSmokeTest {
    ...
    public static void main(String[] args)throws Exception{
        if(args.length<1)throw new IllegalArgumentException("Usage: NativeSmokeTest PATH_TO_NATIVE_EXECUTABLE [desktop|none]");
        ...
        try{
            ...
            require(info.contains("\"mutable\":true")&&info.contains("\"dbaEnabled\":true")&&info.contains("hybrid")&&info.contains("1073741824"),"Default configuration mismatch: "+info);
            ...
            System.out.println("Native smoke passed: bundled Java; Graph/DBA HTTP 200; MCP initialized; admin; hybrid 1 GiB; empty workspace; isolated state/ports.");
        }finally{
